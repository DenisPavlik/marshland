  ...
  return (
    <div className="pt-12">
      <header className="container mb-10">
        ...
        <div className="mt-2 h-9 w-64 bg-gray-100 rounded motion-safe:animate-pulse" />
      </header>

      <section className="container pb-16">
        <div className="flex items-end justify-between mb-8">
          <div className="h-8 w-56 bg-gray-100 rounded motion-safe:animate-pulse" />
          <div className="h-3 w-16 bg-gray-100 rounded motion-safe:animate-pulse" />
        </div>
